                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    ?>
                                    <form method="post" id="jquery-val-form" class="<?php if(!empty($id_produit)){echo 'edit_img_1';}else{echo 'add_img_1';} ?>" data-id="<?php echo $img1['eg_image_produit_id']; ?>" data-id-prod="<?php echo $id_produit ?>">                                                            
                                        ...
                                        <div class="row">                           
                                            <div class="col-12 mb-2">
                                                <div class="border rounded p-2">
                                                    <h4 class="mb-1">Premiere image *:</h4>                                                
                                                                    ...
                                                                    <div class="custom-file">
                                                                        ...
                                                                        <div class="col-md-4 col-6">
                                                                            ...
                                                                            <input id="ckfinder-input-1" type="text" class="form-control" name="img1" value="<?php 
                                                                                ...
                                                                                ?>" <?php if(empty($id_produit)){echo 'required';}?>> 
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-4 col-6">
                                                                            <div class="form-group">
                                                    ...
                                                    <select class="select2 form-control" id="blog-edit-status" name="statut" required>
                                                        <?php 
                                                            if(isset($img1['eg_image_produit_statut'])){
                                                                ...
                                                                {
                                                                    case '1':
                                                                        if($img1['eg_image_produit_statut'] == 1){ echo '<option value="1" selected>Image activée</option><option value="0">Image non activée</option>';}else{ echo '<option value="1">Image activée</option><option value="0">Image non activée</option><option value="" selected>Selectionnez une image ...</option>';}
                                                                    break; 
                                                                                            
                                                                    default:
                                                                    if($img1['eg_image_produit_statut'] == 0){ echo '<option value="1">Image activée</option><option value="0" selected>Image non activée</option>';}else{ echo '<option value="1">Image activée</option><option value="0">Image non activée</option><option value="" selected>Selectionnez une image ...</option>';}
                                                                } 
                                                            }else{

                                                                echo '<option value="1">Image activée</option><option value="0">Image non activée</option><option value="" selected>Selectionnez une image ...</option>';
                                        ...
                                        <div class="row">
                                            <div class="col-12 mt-50">
                                                <button type="submit" class="btn btn-primary mr-1">Enregistrement de la premiere image</button>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    ?>
                                    <form method="post" id="jquery-val-form" class="<?php if(!empty($id_produit)){echo 'edit_img_2';}else{echo 'add_img_2';} ?>" data-id="<?php echo $img2['eg_image_produit_id']; ?>" data-id-prod="<?php echo $id_produit ?>">                                                            
                                        <input name="user" type="hidden" value="<?php echo Membre::info($_SESSION['id'], 'id');?>"> 
                                        <input name="id_produit" type="hidden" value="<?php echo $id_produit;?>"> 
                                        ...
                                        <div class="row">                           
                                            <div class="col-12 mb-2">
                                                <div class="border rounded p-2">
                                                    <h4 class="mb-1">Deuixème image *:</h4>                                                
                                        ...
                                        <div class="row">
                                            <div class="col-12 mt-50">
                                                <button type="submit" class="btn btn-primary mr-1">Enregistrement de la Deuxième image</button>
                                                <button type="reset" class="btn btn-outline-secondary">Annuler</button>
                                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    ?>
                                    <form method="post" id="jquery-val-form" class="<?php if(!empty($id_produit)){echo 'edit_img_3';}else{echo 'add_img_3';} ?>" data-id="<?php echo $img3['eg_image_produit_id']; ?>" data-id-prod="<?php echo $id_produit ?>">                                                            
                                        <input name="user" type="hidden" value="<?php echo Membre::info($_SESSION['id'], 'id');?>"> 
                                        <input name="id_produit" type="hidden" value="<?php echo $id_produit;?>"> 
                                        ...
                                        <div class="row">                           
                                            <div class="col-12 mb-2">
                                                <div class="border rounded p-2">
                                                    <h4 class="mb-1">Troisième image *:</h4>                                                
                                        ...
                                        <div class="row">
                                            <div class="col-12 mt-50">
                                                <button type="submit" class="btn btn-primary mr-1">Enregistrement de la troisème image</button>
                                                <button type="reset" class="btn btn-outline-secondary">Annuler</button>
                                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    ?>
                                    <form method="post" id="jquery-val-form" class="<?php if(!empty($id_produit)){echo 'edit_img_4';}else{echo 'add_img_4';} ?>" data-id="<?php echo $img4['eg_image_produit_id']; ?>" data-id-prod="<?php echo $id_produit ?>">                                                            
                                        <input name="user" type="hidden" value="<?php echo Membre::info($_SESSION['id'], 'id');?>"> 
                                        <input name="id_produit" type="hidden" value="<?php echo $id_produit;?>"> 
                                        ...
                                        <div class="row">                           
                                            <div class="col-12 mb-2">
                                                <div class="border rounded p-2">
                                                    <h4 class="mb-1">Quatrième image *:</h4>                                                
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            <p class="my-50">
                                                                <a id="blog-image-text-1">
                                                                    ...
                                                                    <?php 
                                                                    if(!empty($id_produit)){
                                                                        echo $img4['eg_image_produit_nom'];
                                                                    }else{
                                                                        echo 'C:\fakepath\image.jpg';
                                                                    }
                                                                    ?>
