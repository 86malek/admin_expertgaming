        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
            ...
            <li class="nav-item dropdown dropdown-notification mr-25">
                ...
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                    ...
                    <li class="dropdown-menu-footer"><a class="btn btn-primary btn-block"
                            href="http://<?php echo $_SERVER['SERVER_NAME'];?>/admin_expertgaming/page/module/administrateur/admin/messagerie.php">Voir toutes les messages</a></li>
                </ul>
            ...
            <li class="nav-item dropdown dropdown-user">
                <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="user-nav d-sm-flex d-none">
                        ...
                        <span class="user-status">
                            <?php
                            $query = Bdd::connectBdd()->prepare("SELECT nom_niveau FROM eg_niveau WHERE id = :niveau_id");
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                    <a class="dropdown-item" href="http://<?php echo $_SERVER['SERVER_NAME'];?>/admin_expertgaming/page/module/administrateur/admin/profil.php"><i class="mr-50" data-feather="user"></i>Profile</a>
                    <a class="dropdown-item" href="http://<?php echo $_SERVER['SERVER_NAME'];?>/admin_expertgaming/page/module/administrateur/admin/messagerie.php"><i class="mr-50" data-feather="mail"></i> Messagerie</a>

                    <div class="dropdown-divider"></div>

                    <a class="dropdown-item" href="page-faq.html"><i class="mr-50" data-feather="help-circle"></i> FAQ</a>
                    <a class="dropdown-item" href="http://<?php echo $_SERVER['SERVER_NAME'];?>/admin_expertgaming/page/module/administrateur/admin/deconnexion.php"><i class="mr-50" data-feather="power"></i> Déconnexion</a>
                </div>
            </li>
            <!-- End Profile menu -->
