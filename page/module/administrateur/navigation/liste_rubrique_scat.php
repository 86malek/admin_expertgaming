...
<head>
    ...
    <title>Gestion des Sous-Catégories | Expert Gaming</title>
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click"
            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                    <div class="form-group breadcrumb-right">
                        <div class="dropdown">
                        <button aria-expanded="false" aria-haspopup="true" class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle waves-effect waves-float waves-light" data-toggle="dropdown" type="button">Ajouter une sous-catégorie</button>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="modif_ajout_scat.php"><i data-feather='plus-square'></i>&nbsp&nbsp<span class="align-middle">Ajouter</span></a>
                        </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <table class="datatables-basic table" id="datatable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>id</th>
                                                    <th>Propriétaire</th>
                                                    <th>Titre de la sous-catégorie</th>
    ...
    <script src="http://<?php echo $_SERVER['SERVER_NAME']?>/admin_expertgaming/app-assets/vendors/js/tables/datatable/jquery.dataTables.min.js"></script>
    ...
    <script src="http://<?php echo $_SERVER['SERVER_NAME']?>/admin_expertgaming/app-assets/vendors/js/tables/datatable/responsive.bootstrap4.js"></script>
    ...
    <script src="http://<?php echo $_SERVER['SERVER_NAME']?>/admin_expertgaming/app-assets/vendors/js/tables/datatable/dataTables.rowGroup.min.js"></script>
