...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://<?php echo $_SERVER['SERVER_NAME']?>/<?php echo $PARAM_url_non_doc_site; ?>/app-assets/vendors/css/forms/select/select2.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="http://<?php echo $_SERVER['SERVER_NAME']?>/<?php echo $PARAM_url_non_doc_site; ?>/app-assets/css/themes/bordered-layout.css">
    <link rel="stylesheet" type="text/css" href="http://<?php echo $_SERVER['SERVER_NAME']?>/<?php echo $PARAM_url_non_doc_site; ?>/app-assets/css/plugins/forms/form-quill-editor.css">
    <link rel="stylesheet" type="text/css" href="http://<?php echo $_SERVER['SERVER_NAME']?>/<?php echo $PARAM_url_non_doc_site; ?>/app-assets/css/pages/page-blog.css">
    <link rel="stylesheet" type="text/css" href="http://<?php echo $_SERVER['SERVER_NAME']?>/<?php echo $PARAM_url_non_doc_site; ?>/app-assets/css/plugins/forms/form-validation.css">
    <link rel="stylesheet" type="text/css" href="http://<?php echo $_SERVER['SERVER_NAME']?>/<?php echo $PARAM_url_non_doc_site; ?>/app-assets/css/plugins/forms/pickers/form-flat-pickr.css">
    ...
    <link rel="stylesheet" type="text/css" href="http://<?php echo $_SERVER['SERVER_NAME']?>/<?php echo $PARAM_url_non_doc_site; ?>/app-assets/css/pages/page-blog.min.css">
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static" data-open="click"
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                ...
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                    ...
                    <a style="font-size: 0.9rem !important;" class="btn-sm btn-gradient-secondary waves-effect waves-float waves-light text-nowrap" href="modif_comm.php?id=<?php echo$_GET["id"]; ?>" target="_blank">Preview</a>
                    </div>
                </div>
            </div>
                ...
                <div class="content-body"><!-- Blog Detail -->
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            ...
                            if(!empty($id_comm))
                            {
                                echo '<img src="'.$communication['eg_comm_img'].'" class="img-fluid card-img-top" alt="'.$communication['eg_comm_titre'].'" />';
                            }
                            else
                            {
                                echo '<img src="http://'.$_SERVER['SERVER_NAME'].'/'.$PARAM_url_non_doc_site.'/app-assets/images/slider/03.jpg" class="img-fluid card-img-top" alt="ETAI / COL" />';
                            }
                            ?>
                            <div class="card-body">
                            
                            <h4 class="card-title"><?php if(!empty($id_comm)){echo $communication['eg_comm_titre'];}?></h4>
                            <?php
                            if(!empty($id_comm))
    ...
    <script src="http://<?php echo $_SERVER['SERVER_NAME']?>/<?php echo $PARAM_url_non_doc_site; ?>/app-assets/vendors/js/forms/select/select2.full.min.js"></script>
    ...
    <!-- BEGIN: Page JS-->
    <script src="http://<?php echo $_SERVER['SERVER_NAME']?>/<?php echo $PARAM_url_non_doc_site; ?>/app-assets/js/scripts/pages/page-blog-edit.js"></script>
    <script src="http://<?php echo $_SERVER['SERVER_NAME']?>/<?php echo $PARAM_url_non_doc_site; ?>/app-assets/js/scripts/forms/form-validation.js"></script>
    ...
    <script src="http://<?php echo $_SERVER['SERVER_NAME']?>/<?php echo $PARAM_url_non_doc_site; ?>/app-assets/js/scripts/extensions/ext-component-blockui.js"></script>
    <script src="http://<?php echo $_SERVER['SERVER_NAME']?>/<?php echo $PARAM_url_non_doc_site; ?>/app-assets/vendors/js/forms/validation/jquery.validate.min.js"></script>
    <!-- END: Page JS-->
