...
$(function () {
  ...
  if (dt_basic_table.length) {
    var dt_basic = dt_basic_table.DataTable({
      ajax: 'table/php/data_liste_menu.php?job=get_liste_menu',
      columns: [    
        { data: 'responsive_id' },
        { data: 'id' },
    ...
    $('div.head-label').html('<h6 class="mb-0">Liste des menus principaux du site WEB</h6>');
  ...
  $(document).on('click', '#delete-record', function (e) {
    ...
    Swal.fire({
      ...
      if (result.value) {
              ...
              var request = $.ajax({
                url:          'table/php/data_liste_menu.php?job=del_menu',
                data:         'id_del=' + id,
                type:         'post',
                async: false,
  ...
  $(document).on('submit', '.add', function(e){
      ...
      var onSuccess = function (data) {
        console.log('Success');
        window.location.assign("liste_rubrique_menu.php");
      ...
      var request   = $.ajax({
        url:          'table/php/data_liste_menu.php?job=add_menu',
        data:         form_data,
        type:         'post',
        async: false,
        beforeSend: onBeforeSend,
  ...
  $(document).on('submit', '.edit', function(e){
      ...
      var request   = $.ajax({
        url:          'table/php/data_liste_menu.php?job=edit_menu',
        data:         form_data,
        type:         'post',
        async: false,
        beforeSend: onBeforeSend,
