...
<head>
    ...
    <title>Mot de passe oublié | Expert Gaming</title>
                ...
                <div class="auth-wrapper auth-v1 px-2">
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a class="brand-logo">
                                    <img src="app-assets/images/logo/logo_noir.png" alt="" width="60%">
                                </a>
                                ...
                                <p class="text-center mt-2">
                                    <a href="http://<?php echo $_SERVER['SERVER_NAME']?>/admin_expertgaming/"> <i data-feather="chevron-left"></i> Retour à la connexion</a>
                                </p>
                            </div>
                        </div>
                        <!-- /Forgot Password v1 -->
