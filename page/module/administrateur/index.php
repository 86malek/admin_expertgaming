...
<head>
    ...
    <!-- BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="http://<?php echo $_SERVER['SERVER_NAME'];?>/admin_expertgaming/assets/css/style.css">
    <!-- END: Custom CSS-->
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 p-0">
                            <div class="card card-congratulations">
                                <div class="card-body text-center">
                                    <img src="http://<?php echo $_SERVER['SERVER_NAME'];?>/admin_expertgaming/app-assets/images/elements/decore-left.png" class="congratulations-img-left" alt="card-img-left">
                                    <img src="http://<?php echo $_SERVER['SERVER_NAME'];?>/admin_expertgaming/app-assets/images/elements/decore-right.png" class="congratulations-img-right" alt="card-img-right">
