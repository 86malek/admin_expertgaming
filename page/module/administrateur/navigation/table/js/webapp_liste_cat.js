...
$(function () {
      ...
      if (result.value) {
              ...
              var onSuccess = function (data) {
                ...
                Swal.fire({
                  type: "success",
                  title: 'Supprimé !',
                  text: "Catégorie '" + name + "' supprimée avec succès.",
              ...
              var request = $.ajax({
                url:          'table/php/data_liste_cat.php?job=del_cat',
                data:         'id=' + id,
                type:         'post',
                async: false,
  ...
  $(document).on('submit', '.add', function(e){	  			
      ...
      var onSuccess = function (data) {
        console.log('Success');
        window.location.assign("liste_rubrique_cat.php");
  ...
  $(document).on('submit', '.edit', function(e){
    ...
    e.preventDefault();
      ...
      var request   = $.ajax({
        url:          'table/php/data_liste_cat.php?job=edit_cat',
        data:         form_data,
        type:         'post',
        async: false,
        beforeSend: onBeforeSend,
