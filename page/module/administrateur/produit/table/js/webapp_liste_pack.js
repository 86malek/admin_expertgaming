  ...
  $(document).ready(function(){
    ...
    if (dt_basic_table.length) {
      var dt_basic = dt_basic_table.DataTable({
        ajax: 'table/php/data_liste_produit.php?job=get_liste_produit',
        columns: [    
          { data: 'responsive_id' },
          { data: 'id' },
        ...
        language: {
          ...
          search: "Recherche :",
          zeroRecords: "Aucuns produits disponibles !",
          infoEmpty: "Aucuns produits disponibles !",
          infoFiltered: "(filtré depuis _MAX_ total des enregistrements)",
          loadingRecords: "Chargement des produit en cours ..."
        }
      });
      $('div.head-label').html('<h6 class="mb-0">Liste des Produits / Catalogue | Expert Gaming</h6>');
    ...
    $(document).on('click', '#delete-record', function (e) {
      ...
      Swal.fire({
        ...
        if (result.value) {
                ...
                var request = $.ajax({
                  url:          'table/php/data_liste_produit.php?job=del_produit',
                  data:         'id_del=' + id,
                  type:         'post',
                  async: false,
    ...
    $(document).on('submit', '.edit', function(e){
        ...
        var request   = $.ajax({
          url:          'table/php/data_liste_produit.php?job=edit_produit',
          data:         form_data,
          type:         'post',
          async: false,
          beforeSend: onBeforeSend,
