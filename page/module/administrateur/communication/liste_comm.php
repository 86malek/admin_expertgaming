...
<head>
    ...
    <title>Actualités | <?php echo $PARAM_nom_site; ?></title>
            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                    <div class="form-group breadcrumb-right">
                        <a class="btn-icon btn btn-primary btn-round btn-sm waves-effect waves-float waves-light" href="modif_comm.php">Ajouter une actualité</a>
                    </div>
                </div>
            </div>
