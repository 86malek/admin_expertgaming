...
<head>
    ...
    <title>xxx<?php if(!empty($_GET["id"])){echo'Produit Modification | Expert Gaming';}else{echo'Produit Ajout | Expert Gaming';} ?></title>
                                    ...
                                    <form method="post" id="jquery-val-form" class="<?php if(!empty($id_produit)){echo 'edit';}else{echo 'add';} ?>" data-id="<?php echo $id_produit; ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-12">
                                                <div class="form-group mb-2">
                                                    ...
                                                    name="prix"
                                                    placeholder=""
                                                    value="<?php if(!empty($id_produit)){echo $produit['eg_produit_prix'];}else{echo '0.000';}?>"
                                                    required
                                                    />                                                 
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 mt-50">
                                                <button type="submit" class="btn btn-primary mr-1" id="hporcess">Enregistrement</button>
