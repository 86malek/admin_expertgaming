...
$(function () {
  ...
  if (dt_basic_table.length) {
    var dt_basic = dt_basic_table.DataTable({
      ajax: 'table/php/data_liste_marque.php?job=get_liste_marque',
      columns: [    
        { data: 'responsive_id' },
        { data: 'id' },
    ...
    $('div.head-label').html('<h6 class="mb-0">Liste des Marques</h6>');
  ...
  $(document).on('click', '#delete-record', function (e) {
    Swal.fire({
		  ...
		  if (result.value) {
							...
							var request = $.ajax({
							url:          'table/php/data_liste_marque.php?job=del_marque&id=' + id,
							cache:        false,
							dataType:     'json',
							...
							request.done(function(output){
								if (output.result == 'success'){
									  Swal.fire({
										  type: "success",
										  title: 'Supprimée!',
										  text: "Marque '" + name + "' effacé avec succès.",
  ...
  $(document).on('submit', '.add', function(e){
    ...
    e.preventDefault();
      ...
      var onSuccess = function (data) {
        console.log('Success');
        window.location.assign("liste_rubrique_marque.php");
      ...
      var request   = $.ajax({
        url:          'table/php/data_liste_marque.php?job=add_marque',
        data:         form_data,
        type:         'post',
        async: false,
  ...
  $(document).on('submit', '.edit', function(e){
      ...
      var onBeforeSend = function () {
		  ...
		  var request   = $.ajax({
        url:          'table/php/data_liste_marque.php?job=edit_marque&id=' + id,
        data:         form_data,
        type:         'post',
        async: false,
        beforeSend: onBeforeSend,
